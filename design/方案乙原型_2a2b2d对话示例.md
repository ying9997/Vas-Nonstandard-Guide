...
| 维度 | 2d 标准增值纠偏 | 2a 命名直选 | 2b 其他服务需求 + SOP |
|------|-----------------|-------------|----------------------|
...
|------|----------|----------|----------|----------|
| 2d | 出库标准增值-包裹开箱拍照 | （出库段标准） | 包裹开箱拍照 | standard |
| 2a | 新单上架（客户提供预报单）VASC202412111831129 | OW01V1622 | 入库-提供无箱单预报单上架 | 2a_named |
| 2b | 入库非标增值（特批）VASC202411192246131 | OW01V1602 | 入库其他服务需求 | 2b_catchall |
